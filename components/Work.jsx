  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="grid grid-cols-auto my-10 gap-6 dark:text-black"
      >
      ...
      <motion.a
        ...
        href=""
        className="flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-15 hover:bg-lightHover duration-500 w-max dark:text-white dark:hover:bg-darkHover dark:border-white"
      >
        Show more
        <Image
          alt="Right arrow"
