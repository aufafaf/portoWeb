...
const Work = () => {
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="grid grid-cols-auto sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-10 gap-6">
      ...
      <a
        href=""
        className="flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-15 hover:bg-red-50 duration-500 w-max"
      >
        Show more
        <Image
          alt="Right arrow"
